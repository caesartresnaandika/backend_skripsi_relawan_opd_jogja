 ...
 * - GET /me → Semua role yang login bisa lihat sarannya sendiri
 * - GET /admin → Super Admin lihat semua saran
 * - PATCH /admin/:id/baca → Super Admin update status saran
 */
import { Router } from 'express';
import verifyToken, { authorizeRole } from '../middleware/authMiddleware';
import { getAllSaran, getMySaran, createSaran, updateStatusBaca } from '../controllers/saranController';
...
// GET  /api/saran/me — Riwayat saran pengguna yang sedang login
router.get('/me', verifyToken, getMySaran);
